                    ...
                    <tbody>
                        <tr v-for="question in questions" :key="question.no">
                            ...
                            <td>
                                ...
                                <button @click="deleteQuestion(question.no)" class="delete">
                                    刪除
                                </button>
                            </td>
                        </tr>
            ...
            <div class="modal-content" @click.stop>
                ...
                <form @submit.prevent="saveQuestion">
                    ...
                    <input
                        type="text"
                        id="questionNo"
                        v-model="currentQuestion.no"
                        required
                        :disabled="showEditQuestionModal"
                    />
                    ...
                    <template v-for="option in currentQuestion.options" :key="option.key">
                        ...
                        <label :for="'option_' + option.key + '_image'"
                            >{{ option.key }}選項圖片</label
                        >
                        <input
                            type="file"
